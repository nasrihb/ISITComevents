...
exports.changepassword = function(currentpassword,newpassword,email,callback)  {
...
var salt = hash_data.salt; // get salt
    ...
    user.find({'email': email},function(err,users){
        ...
        var hashed_password = checkHashPassword(currentpassword,salt).passwordHash;
           ...
           user.update({'email':email}, {$set: updateJson},function(err, users){ 
               if (err)  {
                  callback({'response':err});
                   ...
                   callback({'response':'Password successfully updated'});
               });
        }
        else 
        {
        callback({'response':'Wrong Current Password','res':false});               
        }
      });  
}